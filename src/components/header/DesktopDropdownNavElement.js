...
export default function DekstopDropdownNavElement ({ text, sublinks }) {
    ...
    return (
        <li className="p-2 relative group">
            ...
            <ul className="absolute opacity-0 group-hover:opacity-100 -translate-y-2 group-hover:translate-y-0 duration-300 bg-sky-50 overflow-hidden rounded-lg shadow-lg mt-2">
                {
