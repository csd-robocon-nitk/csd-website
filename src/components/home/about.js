export default function AboutSection() {
	return (
		<div className="bg-bg-light text-black flex flex-col justify-center lg:px-60 px-10 items-center py-10 gap-2 min-h-screen">
			<div className="flex justify-evenly items-center w-full gap-4 bg-card-bg rounded-t-xl rounded-b-sm shadow-md px-10 py-5">
			...
			<div className="flex flex-col justify-evenly items-center w-full gap-4 px-10 py-5 bg-card-bg rounded-b-xl rounded-t-sm shadow-md">
