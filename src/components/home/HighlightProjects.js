				...
				>
					...
					<div className="flex flex-col gap-8 w-full absolute justify-center items-start p-8 bg-black/60 h-full">
						...
						<motion.p
							...
							className="text-2xl text-justify"
						>
							SEARCH is a groundbreaking initiative designed to
							revolutionize emergency management and environmental
							monitoring. Developed by the Centre for System
							Design (CSD) at NITK Surathkal, SEARCH integrates
							cutting-edge UHF/VHF/HF radio stations with
							autonomous aerial and marine vehicles, creating a
							robust platform for disaster response,
							communication, and rescue operations. This
							initiative represents a global first, setting new
							standards for how emergencies are managed.
						</motion.p>
					</div>
				</motion.div>
				...
				>
					...
					<div className="flex flex-col w-full gap-8 absolute justify-center items-start p-8 bg-black/60 h-full">
						...
						>
							...
							spearheaded an E-Mobility initiative, developing a
							diverse fleet of electric vehicles, including
							e-cycles, e-scooters, and e-bikes, tailored for
							campus transportation needs. Utilizing AI
							algorithms, the project optimizes vehicle deployment
							and routing based on predicted demand. This
							initiative positions NITK as a leader in sustainable
							campus transportation and demonstrates the Centre's
							expertise in integrating technology for practical,
