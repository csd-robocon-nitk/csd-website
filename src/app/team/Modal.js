...
function Modal({ isOpen, setIsOpen, data }) {
  ...
  return (
    <div className="fixed inset-0 h-screen w-screen flex justify-center items-center z-50 bg-sky-300/50 backdrop-blur-md">
      <div
        className={"rounded bg-white flex flex-col border-sky-900 border-2"}
        ref={modalRef}
      >
        <div className="flex justify-between w-full items-center gap-4 bg-sky-900 text-white p-4 px-16">
