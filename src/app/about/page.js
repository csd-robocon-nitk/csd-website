    ...
    <div className="flex flex-col">
      ...
      <section className="bg-shark-950 text-white relative text-center pt-28 py-20 mb-4 scroll-effect w-full px-24">
        ...
        <div className="relative z-10">
          <h1 className="text-6xl font-extrabold tracking-wide">Welcome to CSD</h1>
          <h2 className="text-3xl mt-4 text-w-900">Innovation Meets Collaboration at NITK Surathkal</h2>
        </div>
      </section>
      ...
      <section className="flex justify-between h-screen items-start text-center scroll-effect px-24">
        ...
        <div className="w-3/5 items-stretch flex flex-wrap justify-center">
          ...
          <div className="flex-1 p-12 bg-gray-200 m-4 rounded-lg shadow-xl">
            ...
            <p className="text-lg">Driving transformative innovation through transdisciplinary research and collaborative expertise, addressing real-world challenges to create a sustainable and technologically advanced future.</p>
          </div>
        </div>
      </section>
      ...
      <section className="h-screen flex justify-between items-start text-center bg-white scroll-effect px-24">
        ...
        <ul className="w-3/5 grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            ...
            <li key={index} className="bg-gray-200 p-8 rounded-lg shadow-xl transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
      ...
      <section className="flex h-screen justify-between items-start text-center scroll-effect px-20 py-5">
        ...
        <div className="flex items-stretch flex-wrap justify-center">
          {[
            ...
            <div key={index} className="bg-gray-200 p-12 m-4 rounded-lg shadow-xl">
      ...
      <section className="flex min-h-screen justify-between items-start text-center bg-white scroll-effect px-24">
        ...
        <div className="flex flex-wrap justify-center">
          {[
            ...
            { title: 'Industry-Academia Collaboration', description: 'Details on partnerships with industries for multidisciplinary research and development.', bgColor: 'bg-gray-200' },
            { title: 'Experiential Learning', description: 'Emphasis on hands-on learning with system design, simulation, and physical experimentation.', bgColor: 'bg-gray-200' },
            { title: 'Advanced Technological Support', description: 'Description of cutting-edge techniques and tools available at CSD.', bgColor: 'bg-gray-200' },
            { title: 'Environmental and Conservation Efforts', description: 'Projects on shoreline analysis, river studies, forestry conservation, etc.', bgColor: 'bg-gray-200' },
            { title: 'Emergency Communication and Product Design', description: 'Innovation in emergency communication, energy harvesting, and biomedical applications.', bgColor: 'bg-gray-200' },
            { title: 'Internships and Student Motivation', description: 'Internship programs and student engagement in real-world projects.', bgColor: 'bg-gray-200' },
            { title: 'Educational Programs', description: 'Workshops, seminars, and training sessions for skill development.', bgColor: 'bg-gray-200' }
          ].map((activity, index) => (
            <div key={index} className={`p-12 m-4 rounded-lg shadow-xl flex-1 transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl ${activity.bgColor}`}>
