...
export default function Contact() {
  return (
    <div className="pt-20 flex gap-2  bg-[#e0e0e0] flex-col justify-center items-center">
      <div className="flex gap-8 justify-center w-full mt-10">
        <div className="flex flex-col gap-8 bg-white rounded-b-sm rounded-t-2xl shadow-lg p-10 w-1/2">
          <h1 className="xl:text-5xl text-xl font-bold text-black">Contact Us</h1>
      ...
      <div className="flex flex-col items-start gap-8 p-10 bg-white rounded-t-sm rounded-b-2xl shadow-lg w-1/2 mb-10">
        <div className="text-black font-bold lg:text-5xl text-xl">Write to us</div>
        <form action="" className="flex flex-col gap-4 w-3/4">
          <span className="text-black lg:text-2xl text-sm">Name</span>
          <input
            type="text"
            placeholder=""
            className="border-b-[2px] focus:border-b-[0.5px] w-1/2  border-[#161616] focus:outline-none placeholder-inherit"
          />
          <span className="text-black lg:text-2xl text-sm">E-mail</span>
          <input
            type="email"
            placeholder=""
            className="border-b-[2px] focus:border-b-[0.5px] w-1/2 border-[#161616] focus:outline-none placeholder-inherit"
          />
          <span className="text-black lg:text-2xl text-sm">Message</span>
          <textarea
            name="message"
            id="message"
            className="border-b-[2px] focus:border-b-[0.5px] border-[#161616] outline-none"
          ></textarea>
          <button className="btn text-white lg:text-2xl text-sm btn-primary bg-[#161616] hover:bg-black ease-in-out hover:scale-[1.05] hover:shadow-2xl duration-200">
            Submit
          </button>
        </form>
      </div>
